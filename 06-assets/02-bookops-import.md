---
title: BookOps Import Notes
part: Iconography and Assets
order: 2
---
...
Each numbered markdown file is a chapter.

Suggested BookOps mapping:

- folder name → part
- file name → chapter order
- YAML frontmatter title → chapter title
- Markdown body → chapter content
